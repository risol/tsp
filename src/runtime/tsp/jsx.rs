...
pub fn wrap_for_bun_cli(transformed: &str, method: &str) -> String {
    let mut out = String::with_capacity(transformed.len() + 256);
    out.push_str("// Generated by TSP v2 PoC 1 slice 6 (jsx.rs)\n");
...
mod tests {
    ...
    #[test]
    fn wrap_emits_call_to_method() {
        let body = "function GET() { return 'ok'; }\n";
        let wrapped = wrap_for_bun_cli(body, "GET");
