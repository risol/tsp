...
> Affected: TSP embedded-worker request execution on Windows
> Severity: CI blocker
...
`docs/reference/adr/0005-embedded-vm-module-readiness.md`.
...
- `scripts/smoke-tspserver.ps1` — Windows integration smoke test;
- `docs/reference/adr/0005-embedded-vm-module-readiness.md` — module-readiness rules.
