...
> Scope: TSP native runtime embedded in Bun
> Related bug: `docs/reference/bugs/0002-mimalloc-operator-delete-sigsegv.md`

## Context

The TSP native runtime is compiled into a Bun binary. In that binary, Rust
...
6. When adding or changing native runtime FFI, run focused Rust tests, a Linux
   embedded-worker release build, and the TSP smoke test.
