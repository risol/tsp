# TSP v2 Context, PageConfig, and Builtins

> Phase 0 topic doc. Source of truth: `tsp-v2-specification.md` §7-§8,
> §10, §14, §16, §18-§19 and `tsp-v2-plan.md` §7-§8, §10, §14, §16,
...
v2.0 default method is `GET`. `POST` fragments are allowed via the
...
Three modules, no more for v2.0:
...
- No `(req, res, next)` middleware chain (plan §44). v2.0 uses
