...
export default Page(async function(ctx, { logger }) {
  ...
  "logger": {
    ...
    "rotation": {          // 日志归档配置
      "maxSize": 10485760, // 10MB - 按大小归档
      "maxFiles": 5,       // 保留 5 个归档
      "compress": true,    // 启用 gzip 压缩
      "daily": false       // true = 按日期归档
    }
  }
}`}</code></pre>
            <ul style="margin-top: 15px;">
              ...
              <li><strong>rotation</strong>：日志归档配置，支持按大小和按日期归档</li>
            </ul>
          </div>

          <div class="test-section">
            <h2>🗄️ 日志归档测试</h2>
            <p>测试日志自动归档功能（按大小、按日期、压缩）</p>
            <a href="/logger_rotation_e2e" class="btn btn-primary mt-2">
              进入归档测试 →
            </a>
          </div>
        </div>
