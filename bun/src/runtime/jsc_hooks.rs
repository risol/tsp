...
/// the VM API lock and is about to synchronously evaluate the result, so this
/// uses the native Rust-side transpiler directly instead of re-entering JSC
/// through a JavaScript host call.
