...
CPP_DECL void Bun__JSC__disableEphemeralScriptCaches();
...
CPP_DECL void JSC__JSGlobalObject__deleteModuleRegistryEntriesForExactPath(JSC::JSGlobalObject* arg0, ZigString* arg1);
